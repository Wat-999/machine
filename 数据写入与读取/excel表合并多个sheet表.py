...
wb = openpyxl.load_workbook('/Users/macbookair/PycharmProjects/pythonProject1/venv/爬虫/全国疫情历史数据.xlsx')
...
with open('/Users/macbookair/PycharmProjects/pythonProject1/venv/爬虫/全国疫情历史数据.xlsx', 'w', newline='') as f:
    writer = csv.writer(f)
